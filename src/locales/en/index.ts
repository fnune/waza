...
const wordComments: Record<WordKey, string> = {
  ...
  kani: "",
  kansetsu: "",
  "kata-single": 'Pronounced the same as "kata" (shoulder).',
  "kata-shoulder": 'Pronounced the same as "kata" (single).',
  katame: "",
  kawazu: "",
  kesa: "Scarf.",
  kibisu: "",
  ...
  obi: "",
  okuri: "The foot that follows, sliding to catch up.",
  okuriashi: "",
  osae: "To suppress.",
  ...
  ude: "Arm.",
  uki: "Floating or unstable position.",
  ura: "One's own back.",
  ushiro: "Behind ↑",
  utsuri: "",
  wakare: "",
