...
const wordComments: Record<WordKey, string> = {
  ...
  do: "",
  eri: "",
  gaeshi: "Reverso o volteo.",
  gake: "Gancho del pie que soporta el peso.",
  garami: "Torsión o enredo usando torque.",
  gari: "Barrido del pie que soporta el peso.",
  ...
  hane: "",
  hara: "",
  harai: "Barrido del pie que soporta menos peso.",
  hiki: "Tirar.",
  hikikomi: "Tirar hacia adentro.",
