...
const wordComments: Record<WordKey, string> = {
  ...
  gake: "Enganchar la pierna que soporta el peso.",
  garami: "Torsión o enredo usando torque.",
  gari: "Segar la pierna que soporta el peso.",
  ...
  hane: "",
  hara: "",
  harai: "Barrer la pierna que soporta menos peso.",
  hiki: "Tirar.",
  hikikomi: "Tirar hacia adentro.",
  ...
  kani: "",
  kansetsu: "",
  "kata-single": 'Se pronuncia igual que "kata" (hombro).',
  "kata-shoulder": 'Se pronuncia igual que "kata" (individual).',
  katame: "",
  kawazu: "",
  kesa: "Bufanda.",
  kibisu: "",
  ...
  tsurikomi: "Elevar y tirar.",
  tsurite: "La mano elevadora, usualmente agarrando la solapa.",
