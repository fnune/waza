...
export async function up(db: Kysely<DB>) {
  ...
  await db
    ...
    .values([
      ...
      },
      {
        ...
        words_romaji: ["sasae", "tsurikomi", "ashi"],
        categories: ["nage-waza", "ashi-waza", "dai-ikkyo"],
      },
      {
        romaji: "uki-goshi",
      ...
      },
      {
        ...
        japanese: "払釣込足",
        video_links: [],
        words_japanese: ["払", "釣込", "足"],
        words_romaji: ["harai", "tsurikomi", "ashi"],
        categories: ["nage-waza", "ashi-waza", "dai-sankyo"],
      },
      {
        romaji: "tomoe-nage",
      ...
      },
      {
        ...
        japanese: "袖釣込腰",
        video_links: [],
        words_japanese: ["袖", "釣込", "腰"],
        words_romaji: ["sode", "tsurikomi", "goshi"],
        categories: ["nage-waza", "koshi-waza", "shinmeisho-no-waza"],
      },
      {
  ...
  await db
    ...
    .values([
      ...
      { romaji: "atama", japanese: "頭", english: "head", description: null },
      { romaji: "ate", japanese: "当て", english: "strike", description: null },
      { romaji: "atemi", japanese: "当て身", english: "body-striking", description: null },
      { romaji: "basami", japanese: "挟", english: "scissors", description: null },
      { romaji: "dai", japanese: "大", english: "big", description: null },
      { romaji: "de", japanese: "出", english: "advanced", description: null },
      { romaji: "deashi", japanese: "出足", english: "advanced foot", description: null },
      ...
      { romaji: "gashira", japanese: "頭", english: "cap", description: null },
      ...
      { romaji: "obi-tori", japanese: "帯取", english: "belt grab", description: null },
      ...
      { romaji: "ryo-te", japanese: "両手", english: "both hands", description: null },
      ...
      { romaji: "sekito", japanese: "蹠頭", english: "ball of foot", description: null },
      ...
      { romaji: "sukashi", japanese: "透", english: "void", description: null },
      ...
      { romaji: "tegatana", japanese: "手刀", english: "hand blade", description: null },
      { romaji: "tsukkomi", japanese: "突込", english: "thrust", description: null },
      { romaji: "tsurikomi", japanese: "釣込", english: "lifting and pulling", description: null },
